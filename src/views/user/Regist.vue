<template>
  <section>
    <div class="mobile-login-item" v-if="!phoneconfirm">
      <div class="row-item">
      ...
      <div class="row-item">
        <input type="button" class="btn-box" value="下一步" @click="togglePhoneConfirm"/>
      </div>
    </div>
    <div class="mobile-login-item" v-if="phoneconfirm">
      <div class="row-item">
      ...
      <div class="row-item">
        <input type="text" class="confirm" placeholder="请确认密码"/>
      </div>
      <div class="row-item">
        <input type="button" class="btn-box" value="按钮" @click="togglePhoneConfirm"/>
      </div>
    </div>
...
<script>
  export default {
    ...
    methods: {
      togglePhoneConfirm: function () {
        this.phoneconfirm = !this.phoneconfirm
        console.dir(this)
      }
    },
    mounted () {
