<template>
  <section>
    ...
    <div class="tips">
      ...
      <a href="http://www.yunlu6.com/yunlu.apk">http://www.yunlu6.com/yunlu.apk</a>
    </div>
  </section>
</template>
...
<style lang="scss" scoped>
  ...
  .top {
    ...
    .header {
      ...
      @include pm2rem(padding, 20px, 30px, 0px, 30px);
      color: $white;
      a {
      ...
      a:active {
        background-color: rgba(73, 180, 149, .4);
      }
    }
    .download-bg {
      img {
        @include px2rem(width, 750px);
        @include px2rem(height, 539px);
      }
    }
  }
  .download-btn {
    @include px2rem(margin-top, 92px);
    text-align: center;
    a {
      display: block;
      text-align: center;
